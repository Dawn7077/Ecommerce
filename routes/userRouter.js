...
// ========================>
    ...
    try { 
    console.log('forgotCurrentPswd link was requested')
    next()
    } catch (error) { 
    console.log(error)
    }
...
router.post('/update-profile', userAuth, updateEmail)
router.get('/change-password', userAuth, getChangePassword)
router.post('/confirm-password', userAuth, passwordConfirm)
router.get('/forgot-current-password',userAuth, forgotCurrentPswd)
